...
The Evolution API is deployed as a separate service from the main application, hosted on Railway. This architectural decision provides isolation and dedicated resources for the critical WhatsApp integration component. The `README.md` confirms Railway as the hosting provider for the WhatsApp server.
