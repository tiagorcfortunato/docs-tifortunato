...
- Designed for English-speaking corporate markets, not Brazilian realities (PIX payments, WhatsApp as primary channel)
...
- **WhatsApp reminders** sent from the professional's own number via Evolution API (not a corporate bot number)
...
- [AI Layer](./ai-layer) — Groq + Llama, tool-calling, dashboard assistant
- [MCP Server](./mcp-server) — local stdio server with 4 tools
- [WhatsApp](./whatsapp) — Evolution API + ~20 message templates
